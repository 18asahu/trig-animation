...
class MyCentralWidget(QWidget):
    ...
    def __init__(self, main_window):
        ...
        self.timed_action = MyMplWidget.timed_action
        #I got an error when I left the contents of the parantheses empty. In lessons, it was left empty. Not sure why I got an error
...
# CHANGELOG: replaced MyMplWidget(self,main_window) with MyMplWidget(self.main_window)
        ...
        #ANWESHA COMMENT: added the missing addStretch functions in missing places and set the vbox layout
    ...
    def on_left_button_clicked(self):
        ...
        self.timed_action.update_sin(self.k)
...
# CHANGELOG: replaced empty sin and cos parentheses with self.mpl_widget.k
    ...
    def on_right_button_clicked(self):
        ...
        self.timed_action.update_cos(self.k)
...
class MyMplWidget(FigureCanvas):
    ...
    def __init__(self, main_window, figsize = (4,2), dpi = 100):
       ...
       # self.MCW = MyCentralWidget()
        ...
        self.timed_action = MyMplWidget.timed_action(self) 
